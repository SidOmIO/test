...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      <a href="index.html" class="custom-logo-link" rel="home"><img width="86" height="66" src="assets/img/logo.png" class="custom-logo" alt="MYUFM"></a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="login.php">Log Masuk</a></li>
        </ul>
...
<!-- ======= Buffet Music Section ======= -->
    <section id="buffet" class="featured-services">
      ...
      <a href="login.php"><button type="button" class="btn btn-danger">Log Masuk untuk request lagu</button></a>
      <br><br>
      </div> 
